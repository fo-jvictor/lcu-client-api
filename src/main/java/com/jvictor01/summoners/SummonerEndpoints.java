...
public class SummonerEndpoints {
    public static final String getSummonerDetailsEndpoint = "/lol-summoner/v2/summoners/names";
    public static final String changeRiotIdEndpoint = "/lol-summoner/v1/save-alias";
